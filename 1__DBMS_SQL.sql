...
(1,  'Computer Science',        'Dr AJAY'),
(2,  'Electronics',             'Mrs SHILPI'),
(3,  'Mechanical',              'Ms Pooja'),
(4,  'Civil',                   'Mr MANOJ KUMAR'),
(5,  'Electrical',              'Dr Seema Dikshit'),
(11, 'Information technology',  'Dr AJAY'),
(21, 'Electrical',              'Mrs SHILPI'),
(31, 'Mechanic',                'Ms Pooja'),
(41, 'Instruments',             'Mr MANOJ KUMAR'),
(51, 'Elementary',              'Dr Seema Dikshit');
...
INSERT INTO STUDENT (Stu_ID, Name, Dept_ID, DOB) VALUES
(101, 'rahul', 1,   '2004-05-12'),
...
INSERT INTO ENROLLMENT (Enroll_ID, Stu_ID, Course_ID, Grade) VALUES
(301, 101, 201, 'A'),
(302, 102, 202, 'B'),
(303, 103, 206, 'A'),
(304, 104, 203, 'C'),
...
SELECT MIN(Grade) AS LowestGrade, MAX(Grade) AS HighestGrade FROM ENROLLMENT;

-- 5.9 Students not enrolled in any course
SELECT *
FROM STUDENT
WHERE Stu_ID NOT IN (SELECT Stu_ID FROM ENROLLMENT);
...
SELECT MIN(GRADE) AS MAXGRADE,MAX(GRADE) AS MINGRADE
FROM ENROLLMENT;

SELECT DEPT_NAME
FROM DEPARTMENT
WHERE DEPT_ID NOT IN(SELECT DEPT_ID FROM COURSE);
